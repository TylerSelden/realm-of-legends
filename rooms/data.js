  ...
  "0": {
    "0": {
      "1": {
        ...
        // description: "This is a quick test to see how my script will hold up. I need this script to be long. I guess it's a string, not a script. It needs to, I believe, be one hundred and sixty two chars long.",
        exits: {
          north: {
            coords: [
              0,
